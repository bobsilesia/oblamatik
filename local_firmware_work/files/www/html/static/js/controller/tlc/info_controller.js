tlcApp.controller('InfoController', function ($scope, $rootScope, tlcService, $stateParams, $translate, $location, Upload, $modal) {
    ...
    $scope.uploadFile = function (room) {
        ...
        if (file == undefined) {
            ...
            Upload.upload({
                url: 'http://' + $scope.TLC.ip + '/api/update-file-upload/',
                file: file
