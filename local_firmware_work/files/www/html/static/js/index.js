...
tlcApp.controller('MainController', function ($scope, $rootScope, $location, $translate, $websocket, $q, $http, tlcService) {
    ...
    $rootScope.global_server_path = 'https://tlc-api.impac.ch/api/';//'http://localhost:8000/api/'; //'https://tlc-api.impac.ch/api/'
    ...
    function landscapeLayout() {
        ...
        $('.mode-selection').css({
            'top': windowHeight / 2 - modeSelection / 2 - 25, // 25 : half of header height
            'left': '20px'
        });
...
//prevents preventDefault from being called on document if it sees a scrollable div
    ...
    tlcService.getTLCs().then(function (TLCs) {
        ...
        angular.forEach($rootScope.TLCs, function (tlc, key) {
            console.log("outdated-check: " + $rootScope.isVersionOutdated(tlc.version, tlc.version_number_downloaded));
